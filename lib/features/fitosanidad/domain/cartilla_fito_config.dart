...
// Offline-first: header tipado + body (map JSON) + observaciones + fotos.
...
class CartillaFitoConfig implements CartillaFormConfig {
  ...
  // ========= Header keys (camelCase - deben calzar con CartillaFitoHeader) =========
  ...
  static const List<CartillaSectionConfig> _sections = [
    ...
    // 8..62 (BODY) - te los dejo EXACTOS como venían en tu config original
    CartillaSectionConfig(
      key: 'thrips_brote',
      title: 'THRIPS-BROTE',
      fields: [
