/*import 'package:donluis_forms/app/auth/auth_gate.dart';
import 'package:donluis_forms/features/splash/splash_page.dart';
...
class _DonLuisAppState extends ConsumerState<DonLuisApp> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_showSplash) {
      ...
      // ✅ Centralizamos todo (login vs sesión) en AuthGate
